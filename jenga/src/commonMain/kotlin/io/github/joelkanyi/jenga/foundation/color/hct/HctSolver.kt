 ...
 */
package io.github.joelkanyi.jenga.foundation.color.hct

import io.github.joelkanyi.jenga.foundation.color.hct.ColorUtils.argbFromLinrgb
import io.github.joelkanyi.jenga.foundation.color.hct.ColorUtils.argbFromLstar
import io.github.joelkanyi.jenga.foundation.color.hct.ColorUtils.yFromLstar
import io.github.joelkanyi.jenga.foundation.color.hct.MathUtils.matrixMultiply
import io.github.joelkanyi.jenga.foundation.color.hct.MathUtils.sanitizeDegrees
import io.github.joelkanyi.jenga.foundation.color.hct.MathUtils.signum
...
internal object HctSolver {
     ...
     * sufficiently close, and chroma will be maximized.
     */
    public fun solveToCam(
        hueDegrees: Double,
        chroma: Double,
        lstar: Double,
    ): Cam16 = Cam16.fromInt(solveToInt(hueDegrees, chroma, lstar))
}
